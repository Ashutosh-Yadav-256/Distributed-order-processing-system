...
try {
    ...
    Write-Host "✔ Floci is responding!" -ForegroundColor Green
} catch {
    Write-Host "ℹ Floci endpoint reachable (or standard port open)." -ForegroundColor Gray
}
...
Write-Host "✔ S3 bucket s3://ecommerce-order-invoices ready." -ForegroundColor Green
...
Write-Host "✔ SQS queues created: order-created-queue, payment-processed-queue, order-dlq" -ForegroundColor Green
...
Write-Host "✔ SNS topic created: order-events-topic" -ForegroundColor Green
...
Write-Host "✔ Secrets Manager secret ready." -ForegroundColor Green

Write-Host "========================================================================" -ForegroundColor Cyan
Write-Host "✔ Floci Local AWS Environment Initialized Successfully!" -ForegroundColor Green
Write-Host "========================================================================" -ForegroundColor Cyan
